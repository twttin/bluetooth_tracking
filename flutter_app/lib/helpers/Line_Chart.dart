...
class Line_Chart extends StatelessWidget {
  ...
  // @TODO ? Both `_Line_ChartPainter` and `Line_Chart` have most the same fields.
  //  `Line_Chart` is just mainly passing them to the painter. Shouldn't there be
  //  only one class containing these data? Some `Line_ChartData` forged inside here
...
class _Line_ChartPainter extends CustomPainter {
  /// Padding around main drawng area. Necessary for displaying labels (around the chart).
  final EdgeInsets padding;
  ...
  /// Creates `_Line_ChartPainter` (`CustomPainter`) with given data and styling.
  _Line_ChartPainter({
  ...
  @override
  bool shouldRepaint(_Line_ChartPainter old) =>
