...
class AA_measurement extends StatefulWidget {
  @override
  _AA_measurementState createState() => _AA_measurementState();
}

class _AA_measurementState extends State<AA_measurement> {
          ...
          children: <Widget>[
            ...
            IconButton(
              icon: Icon(
                Icons.refresh,
                color:
                    Colors.redAccent.withOpacity(isShowingMainData ? 1.0 : 0.5),
              ),
              onPressed: () {
                setState(() {
  ...
  LineChartData sampleData1() {
    return LineChartData(
      ...
      maxY: 5,
      minY: 0,
      lineBarsData: linesBarData1() //insert lastsample data
    );
  }
